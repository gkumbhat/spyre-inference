...
def test_a_real_compile_of_an_outermost_kernel_matches_eager(mode) -> None:
    ...
    torch.testing.assert_close(got_residual, want_residual)    from spyre_inference.custom_ops.layer_norm import SpyreLayerNorm
    from spyre_inference.custom_ops.logits_processor import SpyreLogitsProcessorse, Version 2.0 (the "License");
# you may not use this file except in compliance with the License.
# You may obtain a copy of the License at
#
# http://www.apache.org/licenses/LICENSE-2.0
...
def test_a_real_compile_of_an_outermost_kernel_matches_eager(mode) -> None:
    ...
    torch.testing.assert_close(got, want)
    torch.testing.assert_close(got_residual, want_residual)        (SpyreLayerNorm, "_spyre_forward"),se, Version 2.0 (the "License");
# you may not use this file except in compliance with the License.
# You may obtain a copy of the License at
#
# http://www.apache.org/licenses/LICENSE-2.0
